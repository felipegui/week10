...
function Main({ navigation }) {
    ...
    //Função destinada para quando o usuário parar de mexer no mapa, ter a localização atual.
    function handleRegionChanged(region) {
        setCurrentRegion(region);
    }

    //Senão tiver localização o useEffect não será disparado
    if ( !currentRegion ) {
        return null;
    }
        ...
        <>
            ...
            <View style={styles.searchForm}>
                <TextInput
                    ...
                    placeholder="Buscar um frango ao redor..."
